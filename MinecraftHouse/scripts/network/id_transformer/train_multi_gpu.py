...
from model import IDTransformer
...
class Trainer:
    def __init__(self, d_model, d_hidden, n_head, n_layer,
        ...
        self.transformer = IDTransformer(d_model, d_hidden, n_head, n_layer, dropout).to(self.device)
    ...
    def train(self):
        ...
        for epoch in range(epoch_start, self.max_epoch):
            ...
            for data in tqdm(self.train_dataloader):
                ...
                position_sequence, block_id_sequence, block_category_sequence, next_id_sequence, \
                ...
                id_output = self.transformer(position_sequence,
                                             block_id_sequence,
                ...
                true_id_sum, problem_id_sum = get_accuracy(id_output.detach(), next_id_sequence.detach(), mask.detach())
...
if __name__ == '__main__':
    ...
    opt.save_dir_path = f"ID_{current_time}"
