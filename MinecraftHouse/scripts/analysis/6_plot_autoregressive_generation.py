...
# 데이터 로드
with open('../../datasets/preprocessed/sequence_datasets.pkl', 'rb') as f:
    data = pickle.load(f)

# 첫 번째 시퀀스만 사용
start_idx = 0
end_idx = start_idx + 10
coords_seq = data['coords_sequences'][start_idx:end_idx]
categories_seq = data['category_sequences'][start_idx:end_idx]
